...
// [DEPRECATED - Stock 6px rounded-md / Inter button styles]:
// const legacyButtonBase = "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors"

/* Active Dashboard Design Guide Button Variants (Golos Text 500, Token-driven surface & motion) */
