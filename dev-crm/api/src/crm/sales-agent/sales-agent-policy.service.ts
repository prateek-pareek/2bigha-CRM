...
const TOOL_RISK: Record<string, ToolRiskMeta> = {
  ...
  get_playbook_guidance: { riskTier: 'low', requiredPermissions: ['leads:read'] },
  ...
  recalculate_lead_score: { riskTier: 'low', requiredPermissions: ['leads:write'] },
  ...
  get_playbook_detail: { riskTier: 'low', requiredPermissions: ['leads:read'] },
