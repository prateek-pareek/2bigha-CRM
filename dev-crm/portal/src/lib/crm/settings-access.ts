...
export const CRM_SETTINGS_ITEMS: CrmSettingsItem[] = [
  ...
  { name: "Audit Logs", href: "/crm/settings/audit-logs", requiredPermission: "settings-audit-logs:read" },
  ...
  { name: "Team", href: "/crm/settings/team", requiredPermission: "settings:admin" },
