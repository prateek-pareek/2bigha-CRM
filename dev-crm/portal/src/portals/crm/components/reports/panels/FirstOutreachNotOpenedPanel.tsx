...
export function FirstOutreachNotOpenedPanel({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="w-full rounded-[var(--radius-md)] border-2 border-amber-300 bg-amber-50/70 p-4 sm:p-5 space-y-4 shadow-sm">
            ...
            <div className="space-y-3">
              ...
              {config.alternateSteps.map((step, index) => {
                ...
                return (
                  <div
                    key={step.id}
                    className="rounded-[var(--radius-md)] border border-amber-200/90 bg-white/80 p-4 space-y-3"
                  >
                    <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="space-y-1.5 max-w-xl">
                      ...
                      <CrmDropdown
                        ...
                        className="w-full"
                        buttonClassName="h-11 w-full justify-between border-border bg-card text-sm font-semibold text-text-primary hover:border-primary/40"
