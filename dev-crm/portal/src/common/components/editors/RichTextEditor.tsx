...
const ResizableImageNode = (props: any) => {
  ...
  return (
    <NodeViewWrapper
      ...
      data-drag-handle
      style={wrapperStyle}
      className={`group transition-shadow ${selected ? 'ring-2 ring-[var(--hs-link)] ring-offset-2 rounded-[var(--radius-md)]' : ''}`}
    >
      ...
      <div style={{ position: 'relative', display: 'inline-block', width: '100%' }}>
        <img
          ...
          className="rounded-[var(--radius-md)] border border-[var(--border-color)] shadow-sm pointer-events-none"
        />
...
export default function RichTextEditor({
  ...
  const editor = useEditor({
    ...
    extensions: [
      ...
      ResizableImage.configure({
        HTMLAttributes: {
          class: "rounded-lg border border-[var(--border-color)] max-w-full h-auto mx-1 my-2",
        },
      }),
      Table.configure({
        resizable: true,
    ...
    editorProps: {
      attributes: {
        class: cn(
          ...
          "[&_img]:rounded-[var(--radius-md)] [&_img]:border [&_img]:border-[var(--border-color)] [&_img]:max-w-full [&_img]:h-auto [&_img]:shadow-sm",
          blogMode && [
            ...
            "[&_.blog-table-of-contents]:my-6 [&_.blog-table-of-contents]:rounded-[var(--radius-md)] [&_.blog-table-of-contents]:border [&_.blog-table-of-contents]:border-[var(--border-color)] [&_.blog-table-of-contents]:bg-[var(--surface-dim)] [&_.blog-table-of-contents]:p-4",
            "[&_.faq-section]:my-6",
  ...
  return (
    <div
      className={cn(
        "flex flex-col rounded-[var(--radius-md)] border border-[var(--border-color)] bg-[var(--card-bg)] shadow-sm focus-within:ring-4 focus-within:ring-primary/5 transition-all w-full relative",
        shellMinHeightClass,
        shellClassName,
      )}
    >
      {!readOnly && !hideToolbar ? (
        <div className="flex flex-wrap items-center gap-0.5 border-b border-[var(--border-color)] bg-[var(--card-bg)] p-1.5 sticky top-0 z-[100] shadow-sm rounded-t-2xl">
          ...
          <Popover open={isLinkOpen} onOpenChange={(open) => {
            ...
            <PopoverContent
              className="z-[5000] w-[340px] p-0 shadow-lg border-[var(--border-color)] rounded-[20px] overflow-hidden animate-in zoom-in-95"
              align="start"
              sideOffset={8}
            >
              <div className="bg-[var(--surface-dim)]/50 px-4 py-3 border-b border-[var(--border-color)] flex items-center justify-between">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      className="h-10 text-sm bg-white border-[var(--border-color)] rounded-[var(--radius-md)] focus-visible:ring-primary/20 transition-all font-medium"
                      onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                          e.preventDefault();
                          applyLink();
                    ...
                    <Button
                      size="sm"
                      className="h-10 px-4 shrink-0 bg-[var(--hs-link)] hover:bg-[var(--hs-link)]/90 text-xs font-semibold rounded-[var(--radius-md)] transition-all hover:scale-[1.02] active:scale-95"
                      onClick={applyLink}
                    >
                      Apply
                    </Button>
                ...
                {editor.isActive("link") && (
                  <div className="pt-2 border-t border-slate-50">
                    <Button
                      ...
                      size="sm"
                      onClick={removeLink}
                      className="w-full h-9 text-xs font-semibold text-rose-500 hover:text-rose-600 hover:bg-rose-50 rounded-[var(--radius-md)] transition-all"
                    >
                      Remove Current Link
                    </Button>
                  </div>
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      size="sm"
                      className="h-10 px-6 bg-[var(--hs-link)] hover:bg-[var(--hs-link)]/90 text-xs font-semibold rounded-[var(--radius-md)] transition-all hover:scale-[1.02] active:scale-95 shadow-lg shadow-[var(--hs-link)]/20"
                      onClick={applyImage}
                    >
                      Insert
                    </Button>
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="h-10 text-sm bg-[var(--card-bg)] border-[var(--border-color)] rounded-[var(--radius-md)] focus-visible:ring-primary/20 transition-all font-medium"
                  />
                </div>
              </div>
            </PopoverContent>
          ...
          <Popover>
            ...
            <PopoverContent className="z-[5000] w-48 p-1 shadow-lg border-[var(--border-color)] rounded-[var(--radius-md)] overflow-hidden" align="start">
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="z-[5000] w-56 p-1" align="start" sideOffset={8}>
        {blogMode ? (
          <p className="px-2.5 py-1.5 text-[10px] font-medium leading-snug text-slate-500 border-b border-[var(--border-color)] mb-1">
        ...
        {headingOptions.map((option) => {
          ...
          return (
            <button
              ...
              type="button"
              className={cn(
                "flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-left transition-colors hover:bg-[var(--surface-dim)]",
...
function FontSizeInput({ editor }: { editor: any }) {
  ...
  return (
    <div className="flex items-center gap-1 bg-[var(--surface-dim)] rounded-lg p-0.5 ml-1">
      <Button
        type="button"
        variant="ghost"
        size="sm"
