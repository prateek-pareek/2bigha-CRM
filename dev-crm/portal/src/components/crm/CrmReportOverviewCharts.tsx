...
import CrmDecisionCharts from "@/components/crm/CrmDecisionCharts";
import { cn } from "@/lib/utils";

const PIE_COLORS = ["#ee5f3a", "#425b76", "#16a34a", "#d97706", "#7c3aed", "#0ea5e9", "#64748b"];
...
export default function CrmReportOverviewCharts({
  ...
  if (!selectionReady) {
    return (
      <div className={cn("h-24 rounded-[28px] bg-surface-dim border border-[#ebecf0] animate-pulse", className)} />
    );
  }
    ...
    <div className={cn("space-y-6", className)}>
      {loading ? (
        <div className="grid gap-6 md:grid-cols-2 animate-pulse">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="h-[300px] rounded-[28px] bg-surface-dim border border-[#ebecf0]" />
          ))}
        </div>
      ) : !board ? (
        ...
        <>
          ...
          <div className="mb-2 mt-10">
            <h3 className="text-sm font-bold uppercase tracking-wide text-text-muted mb-3">
    ...
    switch (chartId) {
      case "leads_over_time":
        return {
          ...
          categoryKey: "label",
          series: [
            { key: "count", name: "Leads added", color: "#3b82f6" },
            { key: "rollingAvg", name: "7-day avg", color: "#1d4ed8" },
          ],
      ...
      case "email_replies":
        return {
          ...
          categoryKey: "label",
          series: [{ key: "repliesReceived", name: "Replies", color: "#7c3aed" }],
      ...
      case "email_sends_vs_opens":
        return {
          ...
          series: [
            ...
            { key: "sends", name: "Email sends", color: "#6366f1" },
            { key: "opens", name: "Email opens", color: "#10b981" },
            { key: "replies", name: "Email replies", color: "#7c3aed" },
      ...
      case "follow_up_reply_attempts":
        return {
          ...
          categoryKey: "label",
          series: [{ key: "replies", name: "Replies", color: "#7c3aed" }],
      ...
      case "channel_performance":
        return {
          ...
          series: [
            ...
            { key: "replies", name: "Replies", color: "#7c3aed" },
          ...
          footer:
            channelPerformance.length > 0 ? (
              <div className="overflow-x-auto rounded-[3px] border border-[#ebecf0] shrink-0">
                <table className="w-full text-left text-[11px]">
                  ...
                  <tbody>
                    {channelPerformance.map((row) => (
                      <tr key={row.fullName} className="border-t border-[#ebecf0]">
      ...
      case "top_senders":
        return {
          ...
          fullNameKey: "fullName",
          series: [
            { key: "sends", name: "Sends", color: "#6366f1" },
            { key: "opens", name: "Unique opens", color: "#10b981" },
            { key: "openRate", name: "Open rate %", color: "#7c3aed" },
          ],
      ...
      case "domain_engagement":
        return {
          ...
          fullNameKey: "fullName",
          series: [
            { key: "sends", name: "Sends", color: "#4f46e5" },
      ...
      case "sales_activity":
        return {
          ...
          categoryKey: "label",
          series: [{ key: "count", name: "Activities", color: "#6366f1" }],
      ...
      case "leads_by_pipeline_stage":
        return {
          ...
          series: [
            { key: "count", name: "Open leads", color: "#2563eb" },
      ...
      return (
        <div className="flex h-full flex-col gap-2">
          <div className="grid grid-cols-3 gap-2 shrink-0">
            ...
            <div className="rounded-[3px] bg-emerald-50/80 px-2.5 py-1.5">
            ...
            <div className="rounded-[3px] bg-violet-50/80 px-2.5 py-1.5">
              <p className="text-[9px] font-black uppercase tracking-wider text-violet-700/70">Open rate</p>
              <p className="text-sm font-bold tabular-nums text-violet-700">{emailTotals.rate}%</p>
            </div>
          </div>
...
function ChartTypeToggle({
  ...
  return (
    <div className="inline-flex items-center gap-0.5 rounded-[3px] border border-[#dfe1e6] bg-[#f4f5f7]/80 p-0.5 shrink-0">
      ...
      <div className="mb-4 flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-wrap items-start justify-between gap-2">
            ...
            {switchable && viewType && onViewTypeChange ? (
              <ChartTypeToggle value={viewType} onChange={onViewTypeChange} />
            ) : null}
          </div>
        </div>
      </div>
...
function MiniKpi({
  ...
  return (
    <div className="rounded-[3px] border border-[#ebecf0] bg-surface-dim/40 px-3 py-3">
      ...
      <p className="text-lg font-semibold text-text-main tabular-nums">{value}</p>
