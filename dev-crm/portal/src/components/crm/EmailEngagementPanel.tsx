  ...
  return (
    <div className="rounded-[var(--crm-radius-ui)] border border-[var(--border-color)] bg-[var(--card-bg)] p-4 shadow-[var(--crm-shadow-card)]">
      <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        ...
        <span
          className="inline-flex items-center gap-1 text-xs font-medium text-text-muted max-w-[220px]"
        ...
        >
          ...
          <span className="leading-tight">Pixel opens may be blocked by the recipient.</span>
        </span>
      </div>
      {trackingLocalOnly ? (
