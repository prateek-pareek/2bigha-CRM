    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex items-start gap-3 min-w-0">
          <div className="p-2.5 rounded-[3px] bg-violet-100 text-violet-700 shrink-0">
            <GitBranch size={22} />
          </div>
      ...
      {byWorkflow.length > 0 && !loading && !loadError && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
          <div className="bg-card border border-[#ebecf0] rounded-[3px] p-5 shadow-sm">
          ...
          <div className="bg-card border border-[#ebecf0] rounded-[3px] p-5 shadow-sm">
            <h3 className="text-xs font-semibold text-text-muted mb-4">Top Workflows</h3>
          ...
          <div className="rounded-[3px] border border-[var(--hs-link)] bg-[var(--hs-link)]/5 p-5 shadow-sm lg:col-span-2">
