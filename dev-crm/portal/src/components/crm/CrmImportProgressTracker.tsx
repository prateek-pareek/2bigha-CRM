    ...
    <div className="fixed bottom-6 right-6 z-[60] flex flex-col gap-3 max-w-sm w-full pointer-events-none">
      {jobs.map((job) => {
        ...
        return (
          <div
            key={job.jobId}
            className="pointer-events-auto bg-card border border-[#dfe1e6] rounded-[3px] shadow-lg shadow-slate-900/10 p-4 animate-in slide-in-from-bottom-4 duration-300"
          >
