    ...
    >
      {success ? (
        <div className="py-8 flex flex-col items-center text-center space-y-4">
          <div className="w-20 h-20 rounded-[28px] bg-emerald-500/10 text-emerald-500 flex items-center justify-center">
        ...
        <div className="space-y-4 -mx-1">
          {(
            ...
            <button
              ...
              className={`w-full flex items-center gap-4 p-4 rounded-[3px] border-2 transition-all text-left ${
                convertType === type
                  ? "border-[var(--hs-link)] bg-[var(--hs-link)]/5"
                  : "border-[var(--border-color)] hover:border-[var(--hs-link)]/40 hover:bg-[var(--background)]"
              }`}
            >
              <div
                className={`w-12 h-12 rounded-[3px] flex items-center justify-center shrink-0 ${
                  convertType === type
                    ? "bg-[var(--hs-link)]/10 text-[var(--hs-link)]"
