...
const PERMISSIONS: Array<{ name: string; description: string }> = [
  ...
  { name: 'deals:read', description: 'View deals' },
  { name: 'deals:read:team', description: 'View deals owned by your team' },
  { name: 'deals:write', description: 'Create and edit deals' },
  { name: 'deals:move_pipeline', description: 'Move deals between pipelines' },
