...
const EXTRA_PERMS: Array<{ name: string; module: string; description: string }> = [
  ...
  { name: 'pm-leads:move_pipeline', module: 'pm-leads', description: 'Move PM leads across pipelines' },
  ...
  { name: 'pm-leads:read:team', module: 'pm-leads', description: 'View team PM leads' },
  { name: 'pm-leads:read:all', module: 'pm-leads', description: 'View all PM leads' },
...
const COMPANY_ROLES: RoleSeed[] = [
  ...
  },
  {
    ...
    permissions: [
      ...modulePerms(
        ['dashboard', 'workspace', 'clients', 'contacts', 'organizations', 'activities', 'inbox', 'pm-leads'],
        ['read', 'write', 'edit'],
      ),
      'pm-leads:read:all',
