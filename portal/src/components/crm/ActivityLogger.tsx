...
export default function ActivityLogger({
  ...
  const inputClass = isHubspot
    ...
    : "w-full h-10 bg-surface-dim border border-border/60 rounded-[3px] px-3 text-sm text-text-main outline-none placeholder:text-text-muted/50 focus:ring-2 focus:ring-primary/20 focus:border-primary/30 transition-all";
  ...
  const textareaClass = isHubspot
    ...
    : "w-full bg-surface-dim border border-border/60 rounded-[3px] px-3 py-2.5 text-sm text-text-main outline-none placeholder:text-text-muted/50 focus:ring-2 focus:ring-primary/20 focus:border-primary/30 transition-all resize-y";
  ...
  const selectClass = isHubspot
    ...
    : "w-full h-10 bg-surface-dim border border-border/60 rounded-[3px] px-3 text-sm text-text-main outline-none cursor-pointer focus:ring-2 focus:ring-primary/20 focus:border-primary/30 transition-all appearance-none";
  ...
  const btnClass = isHubspot
    ...
    : "inline-flex items-center gap-2 rounded-[3px] bg-primary px-6 py-2.5 text-sm font-bold text-white shadow-sm transition-all hover:bg-primary-dark active:scale-95 disabled:pointer-events-none disabled:opacity-45";

  return (
    <div
      className={cn(
        !isFixedTask &&
          'bg-white rounded-[32px] border border-border/60 shadow-sm overflow-hidden animate-in fade-in slide-in-from-top-4 duration-500',
        isFixedTask && 'rounded-[3px] border-0 bg-transparent shadow-none overflow-visible',
        className,
      )}
    >
      {!fixedType && (
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <DatePickerField
                  ...
                  buttonClassName={isHubspot ? "h-10 rounded-md border-[var(--border-color)] bg-white hover:bg-[var(--background)] text-sm text-[var(--text-main)] font-normal w-full justify-start text-left pl-3" : "h-10 rounded-[3px] border-border/60 bg-surface-dim hover:bg-white text-sm text-text-main font-normal w-full justify-start text-left pl-3"}
                />
              </div>
              <div>
