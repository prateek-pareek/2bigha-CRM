    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="flex h-auto min-h-10 min-w-[200px] max-w-[400px] flex-1 items-center justify-between gap-2 overflow-hidden rounded-[3px] border-[#dfe1e6] bg-surface-dim px-3 py-1.5 text-sm font-medium hover:bg-surface-dim hover:text-text-main"
        >
