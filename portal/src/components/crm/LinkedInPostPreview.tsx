...
export default function LinkedInPostPreview({ metadata }: { metadata: LinkedInMetadata }) {
  ...
  return (
    <div className="mt-3 border border-[#ebecf0] rounded-[3px] overflow-hidden bg-white shadow-sm animate-in fade-in slide-in-from-top-1 duration-300">
      {/* Header */}
      <div className="px-4 py-3 flex items-start justify-between border-b border-slate-50/50 bg-surface-dim/10">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center overflow-hidden border border-[#dfe1e6]">
      ...
      <div className="p-4 space-y-3">
        ...
        {metadata.image && (
          <div className="relative rounded-[3px] overflow-hidden border border-[#ebecf0] aspect-video bg-[#f4f5f7] group">
