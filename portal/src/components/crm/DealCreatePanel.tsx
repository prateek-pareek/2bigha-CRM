  ...
  const panelInner = (
    <>
      <CrmSlidePanelShell
        ...
        subtitle="All standard and custom fields — use Fields to choose what appears"
        headerTone="hubspot"
        headerActions={
          <button
            type="button"
        ...
        footer={
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {loading && !saveAndAddAnother ? "Creating…" : "Create deal"}
            </button>
            <button
              type="button"
              onClick={onClose}
      ...
      >
        <form id="deal-create-form" ref={formRef} onSubmit={handleSubmit} className="space-y-4">
          <CRMDealFormFields
