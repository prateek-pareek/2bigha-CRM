...
import CRMDealFormFields from '@/components/crm/CRMDealFormFields';
import CRMContactFormFields from '@/components/crm/CRMContactFormFields';
import CRMOrganizationFormFields from '@/components/crm/CRMOrganizationFormFields';
import CRMClientFormFields from '@/components/crm/CRMClientFormFields';
    ...
    <div className={crmModalChrome.overlay} style={{ isolation: 'isolate' }}>
      ...
      <div className={`${crmModalChrome.slidePanel} max-w-xl`}>
        ...
        {tabs.length > 0 && (() => {
          ...
          return (
            <div className="p-6 bg-surface-dim/30 border-t border-[#ebecf0] shrink-0">
                ...
                {showAddAnother && (
                  <button
                    ...
                    className={`flex-1 py-3 rounded-md font-semibold text-sm shadow-sm transition-colors flex items-center justify-center gap-2 border ${
                      isDisabled
                        ? 'bg-slate-100 text-slate-400 border-[#dfe1e6] cursor-not-allowed'
