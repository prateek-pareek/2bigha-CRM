...
export default function SalesAgentRecordPanel({ recordType, recordId }: Props) {
  ...
  if (loading) {
    return (
      <div className="rounded-[3px] border border-[var(--border-color)] bg-white p-4">
  ...
  return (
    <div className="rounded-[3px] border border-violet-200/80 bg-gradient-to-br from-violet-50/80 to-white p-4">
