...
export default function CRMFieldLayoutCustomizer({
  ...
  const content = (
    <div className={`${crmModalChrome.overlay} z-[10001] flex items-center justify-center p-4`}>
      ...
      <div className={`${crmModalChrome.centerShell} max-w-md max-h-[85vh] crm-modal`}>
        ...
        <div className={`${crmModalChrome.centerFooter} gap-2`}>
          ...
          <button
            type="button"
            onClick={handleSave}
            className="inline-flex h-8 flex-1 items-center justify-center rounded-[var(--radius-md)] bg-[var(--primary)] px-3 text-sm font-medium text-white hover:bg-[var(--primary-dark)]"
          >
            Save
          </button>
        </div>
