...
export function SalesCopilotWidget() {
  ...
  return (
    <>
      ...
      {open ? (
        <div className="fixed bottom-24 right-5 z-[60] flex h-[min(72vh,640px)] w-[min(420px,calc(100vw-2rem))] flex-col overflow-hidden rounded-[var(--radius-md)] border border-[var(--border-color)] bg-[var(--background)] shadow-lg">
