  ...
  return (
    <div className={cn("space-y-5", className)}>
      <div className="rounded-md border border-[var(--border-color)] bg-white shadow-[0_1px_4px_rgba(0,0,0,0.06)] overflow-hidden">
        <div className="px-6 py-5 border-b border-[var(--surface-dim)] bg-[var(--surface-dim)] space-y-4">
        ...
        return (
          ...
          >
            <button
              ...
              className="flex w-full items-center gap-3 px-5 py-3.5 border-b border-[var(--surface-dim)] bg-[var(--surface-dim)] text-left hover:bg-[var(--background)] transition-colors"
            >
