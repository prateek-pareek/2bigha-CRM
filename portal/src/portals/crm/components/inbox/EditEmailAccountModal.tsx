...
} from '@/components/crm/inbox/inbox-mail-providers';
...
const fieldClass =
  'mt-1.5 block w-full rounded-[var(--radius-md)] border border-border bg-surface-dim/30 text-sm font-semibold h-10 px-4';
const labelClass =
    ...
    >
      ...
      <div
        className={cn(
          ...
          "crm-modal max-h-[min(92dvh,800px)] sm:max-w-xl",
          "rounded-t-[3px] sm:rounded-[var(--radius-md)]",
        )}
      >
        ...
        <form onSubmit={handleSubmit} className="flex min-h-0 flex-1 flex-col">
          <div className="min-h-0 flex-1 space-y-4 overflow-y-auto overscroll-contain px-5 py-4 custom-scrollbar">
            ...
            {isPasswordAuth ? (
              ...
              <p className="text-xs text-text-muted leading-relaxed rounded-[var(--radius-md)] border border-border bg-surface-dim/30 px-3 py-2.5">
          ...
          <div className="shrink-0 flex flex-wrap gap-2 border-t border-border bg-card px-5 py-3">
            <CrmButton
              ...
              variant="secondary"
              onClick={onClose}
              className="h-10 rounded-[var(--radius-md)] text-sm font-bold px-4"
            >
              Cancel
            </CrmButton>
            {isPasswordAuth && (
              <CrmButton
                ...
                className="h-10 rounded-[var(--radius-md)] gap-2 text-sm font-bold px-4"
              >
                {syncing ? (
            ...
            <CrmButton
              ...
              variant="primary"
              disabled={submitting}
              className="flex-1 min-w-[120px] h-10 rounded-[var(--radius-md)] gap-2 text-sm font-bold"
            >
              {submitting ? (
                <Loader2 size={16} className="animate-spin" />
              ) : (
