...
export const LEAD_FIELD_DEFS: CrmFieldDef[] = [
  ...
  { key: 'firstCallResponse', label: 'First Call Response', recordOnly: true },
  { key: 'lastCallAt', label: 'Last Call Date', recordOnly: true },
  { key: 'callbackScheduledAt', label: 'Callback Schedule Date', recordOnly: true },
  { key: 'currentSubscriptionPlan', label: 'Subscription Plan', recordOnly: true },
