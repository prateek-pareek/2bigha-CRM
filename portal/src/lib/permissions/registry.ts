...
/** Extra flat keys (not module:action) assignable per CRM module in Role Manager. */
...
const HRMS_MODULE_ROWS: Omit<PermissionModuleDef, 'suite'>[] = [
  ...
  { id: 'payroll', label: 'Payroll (Sensitive Salary Data)', routes: ['/hrms/payroll'], apiSegment: 'payroll' },
  { id: 'expenses', label: 'Expenses', routes: ['/hrms/expenses'], apiSegment: 'expenses' },
  { id: 'benefits', label: 'Benefits', routes: ['/hrms/benefits'], apiSegment: 'benefits' },
  { id: 'analytics', label: 'Analytics', routes: ['/hrms/analytics'] },
  { id: 'reports', label: 'Reports', routes: ['/hrms/reports'] },
  ...
  { id: 'hr-settings', label: 'HR Settings / HR Admin', routes: ['/hrms/hr-settings', '/hrms/roles', '/hrms/audit-logs'], apiSegment: 'hr-settings' },
...
const CRM_MODULE_ROWS: Omit<PermissionModuleDef, 'suite'>[] = [
  { id: 'dashboard', label: 'Dashboard, workspace & analytics', routes: ['/crm/workspace', '/crm/reports', '/crm/copilot', '/crm/intelligence', '/crm/notifications', '/crm/virtual-office'] },
  ...
  { id: 'strategies', label: 'Sales strategies', routes: ['/crm/strategies'], apiSegment: 'sales-strategies' },
  { id: 'workflows', label: 'Workflows & automation', routes: ['/crm/workflows'] },
  { id: 'settings', label: 'Settings, templates & playbooks', routes: ['/crm/settings', '/crm/playbooks'] },
  ...
  { id: 'settings-playbooks', label: 'Settings · Playbooks', routes: ['/crm/settings/playbooks'] },
  ...
  { id: 'settings-audit-logs', label: 'Settings · Audit Logs', routes: ['/crm/settings/audit-logs'] },
